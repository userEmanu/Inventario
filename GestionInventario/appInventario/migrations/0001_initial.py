    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('ubiElemento', models.ForeignKey(db_comment='Hace referencia al elemento', on_delete=django.db.models.deletion.PROTECT, to='appInventario.elemento')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('solFicha', models.ForeignKey(db_comment='Ficha en la que el instructor utilizará los elementos', on_delete=django.db.models.deletion.PROTECT, to='appInventario.ficha')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('salDetalleSolicitud', models.ForeignKey(db_comment='Hace referencia al detalle de la solicitud', on_delete=django.db.models.deletion.PROTECT, to='appInventario.detallesolicitud')),
            ],
        ),
        migrations.CreateModel(
            name='Material',
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('matElemento', models.ForeignKey(db_comment='Hace referencia al Elemento FK', on_delete=django.db.models.deletion.PROTECT, to='appInventario.elemento')),
                ('matUnidadMedida', models.ForeignKey(db_comment='Hace referencia a la Unidad de Medida FK', on_delete=django.db.models.deletion.PROTECT, to='appInventario.unidadmedida')),
            ],
        ),
        migrations.CreateModel(
            name='Mantenimento',
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('manElemento', models.ForeignKey(db_comment='Hace referencia al elemento que se le realizó el mantenimiento', on_delete=django.db.models.deletion.PROTECT, to='appInventario.elemento')),
                ('manEstado', models.ForeignKey(db_comment='Hace referencia al estado del mantenimiento', on_delete=django.db.models.deletion.PROTECT, to='appInventario.estadomantenimiento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('entProveedor', models.ForeignKey(db_comment='Hace referencia al proveedor que entrea los materiales', on_delete=django.db.models.deletion.PROTECT, to='appInventario.proveedor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('devElemento', models.ForeignKey(db_comment='Hace relación al elemento FK', on_delete=django.db.models.deletion.PROTECT, to='appInventario.elemento')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('devSalida', models.ForeignKey(db_comment='Hace referencia a la salida de los elementos', on_delete=django.db.models.deletion.PROTECT, to='appInventario.salidadetallesolicitud')),
        ...
        migrations.AddField(
            ...
            name='detElemento',
            field=models.ForeignKey(db_comment='Elemento que se está solicitando', on_delete=django.db.models.deletion.PROTECT, to='appInventario.elemento'),
        ),
        migrations.AddField(
            model_name='detallesolicitud',
            name='detSolicitud',
            field=models.ForeignKey(db_comment='Hace referencia a la solicitud del detalle que se va a registrar', on_delete=django.db.models.deletion.PROTECT, to='appInventario.solicitudelemento'),
        ),
        migrations.AddField(
            model_name='detallesolicitud',
            name='detUnidadMedida',
            field=models.ForeignKey(db_comment='Unidad de médida del elemento que se requeire', on_delete=django.db.models.deletion.PROTECT, to='appInventario.unidadmedida'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devEstado', models.CharField(choices=[('Bueno', 'Bueno'), ('Regular', 'Regular'), ('Malo', 'Malo')], db_comment='estado del Elemento', max_length=7)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('detEntradaMaterial', models.ForeignKey(db_comment='Hace referencia a la Entrada registrada', on_delete=django.db.models.deletion.PROTECT, to='appInventario.entradamaterial')),
                ('detMaterial', models.ForeignKey(db_comment='Hace referencia al material que se está registrando en la entrada', on_delete=django.db.models.deletion.PROTECT, to='appInventario.material')),
            ],
        ),
    ]
